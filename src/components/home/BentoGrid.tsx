            ...
            <div className="max-w-[1400px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
                    ...
                    <div className="md:col-span-5 flex flex-col gap-8 md:gap-12">
                        <div className="w-full h-[400px] bg-[var(--bg-secondary)] overflow-hidden relative group">
                            <Image src="https://images.unsplash.com/photo-1614252235316-8c857d38b5f4?q=80&w=2930&auto=format&fit=crop" alt="Shoes" fill className="object-cover opacity-70 group-hover:opacity-100 group-hover:scale-105 transition-all duration-1000" />
                        ...
                        <div className="p-10 border border-[var(--border)] backdrop-blur-sm bg-[var(--glass-bg)] flex-1 flex flex-col justify-center">
